...
public class NotificationService {
    ...
    //@Scheduled(cron = "0 * * * * *", zone = "IST")//envio de notificaciones cada minuto prueba
    ...
    //@Scheduled(cron = "0 * * * * *", zone = "IST") prueba
    @Scheduled(cron = "0 0 23 * * *", zone = "IST")
    public void sendDailyExpenseSumary(){
        log.info("Job started: sendDailyExpenseSumary()");
        List<ProfileEntity> profiles = profileRepository.findAll();
        for(ProfileEntity profile : profiles){
            ...
            if (!todayExpenses.isEmpty() ) {
                ...
                table.append("</table>");
                String body = "Hi "+ profile.getFullName()+",<br/><br/> Here is a sumary  of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>Money Manager Team";
                emailService.sendEmail(profile.getEmail(), "Your daily Expense summary", body);

                
            }
        }
        log.info("Job completed: sendDailyExpenseSumary()");
    }
